...
///  tA->makePlot("GetMT2MuEG()",     cuts,    -10,  -10 , -10 ,   trigger , "MT2"            ,20,0,400,        false,        true ,  true,   true,  true,  true, 1, 1);
  ...
  tA->makePlot("doubleTau.MT2",     cuts,    -10,  -10 , -10 ,   trigger , "MT2"            ,10,0,1000,        false,        true ,  true,   true,  true,  true, 1, 1);     
  tA->makePlot("misc.MET",     cuts,   -10,  -10 , -10 ,   trigger , "MET"            ,10,0,1000,        false,        true ,  true,   true,  true,  true, 1, 1);       
  tA->makePlot("doubleTau.MT2Imbalanced",     cuts,   -10,  -10 , -10 ,   trigger , "MT2Imbalanced"            ,10,0,1000,        false,        true ,  true,   true,  true,  true, 1, 1);       
  tA->makePlot("doubleTau.METImbalanced",     cuts,   -10,  -10 , -10 ,   trigger , "METImbalanced"            ,10,0,1000,        false,        true ,  true,   true,  true,  true, 1, 1);       */
  tA->makePlot("NTaus",     cuts,   -10,  -10 , -10 ,   trigger , "n_{#tau}"            ,10,0,10,        false,        true ,  true,   true,  true,  true, 1, 1);       
  tA->makePlot("NMuons",     cuts,   -10,  -10 , -10 ,   trigger , "n_{#mu}"            ,10,0,10,        false,        true ,  true,   true,  true,  true, 1, 1);       
  tA->makePlot("NEles",     cuts,   -10,  -10 , -10 ,   trigger , "n_{e}"            ,10,0,10,        false,        true ,  true,   true,  true,  true, 1, 1);       
  // tA->makePlot("GetMT2DoubleMu()",     cuts,    -10,  -10 , -10 ,   trigger , "MT2"            ,20,0,400,        false,        true ,  true,   true,  true,  true, 1, 1); u
